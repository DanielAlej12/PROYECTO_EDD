...
public:
    ...
    // 3. Asignar nuevo dueño del hechizo según las reglas detalladas
    void asignarNuevoDuenio() {
        ...
        // 3.b. Dueño murió y no tiene discípulos
        ...
        // 3.c. Compañero no vivo ni tiene hijos, dueño pasa a compañero del maestro
        ...
        // 3.d. Si maestro está muerto (padre del dueño) reintentar reglas desde raíz
        ...
        // 3.e. Mujer más joven con discipulos cuyo maestro fue dueño y tiene magia mixed
        ...
        // 3.f. Si ninguna condición es válida, buscar mujer más joven viva
        candidata = nullptr;
        edadCandidata = 1000;
        ...
        // 3.g. Si el mago dueño pasó de los 70 años
        if (duenio->age > 70) {
    ...
    // 4. Modificar datos de mago (excepto id e id_father)
